    ...
    <table  class="table table-bordered table-striped">
        ...
        <tbody> 
            ...
            do {
                ...
                echo "<td>";
                $total += $bulanan['qty']!=0 ? $bulanan['qty'] : 0;
                echo $bulanan['qty']!=0 ? number_format($bulanan['qty']) : "<i class='text-muted'>0</i>";
                echo "</td>"; 
                echo "<td>"; 
                echo round($regresi->all[$n],2);
                if ($regresi->all[$n] < 0) {
        ...
        <tfoot>
            ...
            <th><?php echo round($hasilregresi,2) ?></th>
        </tfoot>
    </table>
    <?php
