          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("INSERT INTO barang_dagang(nama_barang,id_jenis,harga_kilo,gambar_barang) VALUES('$nm_brg','$jenis_barang','$hrg_kg','$fotobarang')") or die (mysqli_error($koneksi));

                $idbarang = $koneksi->insert_id;

                 $koneksi->query("INSERT INTO barang_masuk(id_barang,nama_barang,id_jenis) VALUES('$idbarang','$nm_brg','$jenis_barang')") or die (mysqli_error($koneksi));
              ?>
