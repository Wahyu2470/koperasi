        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <?php 
              $id = @$_GET['id'];
              $sql = mysqli_query($koneksi,"SELECT *FROM barang_dagang JOIN jenis_barang ON barang_dagang.id_jenis=jenis_barang.id_jenis where barang_dagang.id_barang = '$_GET[id]'") or die(mysqli_error());
