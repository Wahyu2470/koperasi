<section id="main-content">
      <section class="wrapper">
        <h3>Tambah Data Iuran Anggota</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Tambah Data Iuran Anggota</h4>
              ...
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("INSERT INTO iuran_detail(id_anggota,tanggal_iuran,jumlah_iuran) values('$anggota','$tanggal','$dana')") or die (mysqli_error($koneksi));
