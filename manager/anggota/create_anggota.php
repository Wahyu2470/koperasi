        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Tambah Data Anggota</h4>
              <form class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Nomor KTP</label>
                  <div class="col-sm-10">
                    <input type="number" name="nik" class="form-control" placeholder="Masukan Nomor KTP Anda">
                  </div>
                </div>
                <div class="form-group">
              ...
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("INSERT INTO anggota(nama_anggota,username,password,alamat,no_tlp,no_ktp,foto_anggota) values('$nama','$username','$password','$alamat','$notlp','$nik','$fotoidentitas')") or die (mysqli_error());

              ?>
              <script type="text/javascript">
                alert("Sukses. Data Berhasil Di Simpan");
                window.location.href='index.php?halaman=anggota';
              </script>
            <?php }; ?>
            </div>
          </div>
