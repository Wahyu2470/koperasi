          ...
          <div class="col-lg-12">
            <div class="content-panel">
              ...
              <div class="nav right">
                ...
                <?php 
                    $nomor=1;
                    $sql = $koneksi->query("SELECT *FROM simpan_anggota JOIN anggota ON simpan_anggota.id_anggota = anggota.id_anggota JOIN simpan ON simpan_anggota.id_simpanan=simpan.id_simpanan") or die(mysqli_error());?>
