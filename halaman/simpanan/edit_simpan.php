        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <?php 
              $id = @$_GET['id'];
              $sql = mysqli_query($koneksi,"SELECT *FROM simpanan_detail JOIN anggota ON simpanan_detail.id_anggota = anggota.id_anggota where id_simpanan = '$_GET[id]'") or die(mysqli_error());
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control custom-select input-lg" name="jenis_simpanan">
                      ...
                      <option value="1" <?php echo ($data['id_jenis_simpanan']=='1')?'selected':''  ?>>Wajib</option>
                      <option value="2" <?php echo ($data['id_jenis_simpanan']=='2')?'selected':''  ?>>Pokok</option>
                    </select>
                  </div>
              </div>
                <div class="form-group">
              ...
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("UPDATE simpanan_detail set id_jenis_simpanan='$_POST[jenis_simpanan]',jumlah_simpan='$_POST[dana]', tanggal_simpan='$_POST[tanggal]' where id_simpanan='$_GET[id]'") or die (mysqli_error());

                $koneksi->query("UPDATE simpanan set id_jenis_simpanan='$_POST[jenis_simpanan]',jumlah_simpan='$_POST[dana]' where id_simpanan='$_GET[id]'") or die (mysqli_error());
              ?>
