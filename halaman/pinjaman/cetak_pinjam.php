...
<div class="table-responsive" style="padding: 10px;">
  ...
  <table id="dariom" class="table table-bordered table-striped ">
    ...
    <tbody>
      <?php 
      $no=1;
      $sql = "SELECT *FROM pinjaman_anggota JOIN anggota ON pinjaman_anggota.id_anggota = anggota.id_anggota JOIN pinjaman_detail ON pinjaman_anggota.id_pinjam=pinjaman_detail.id_pinjam JOIN cicilan ON pinjaman_anggota.id_cicilan=cicilan.id_cicilan";
