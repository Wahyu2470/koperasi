  ...
  <table id="dariom" class="table table-bordered table-striped ">
    ...
    <tbody>
      ...
      $sql = $koneksi->query("SELECT *FROM pembelian_barang JOIN pembelian 
             ...
             ON pembelian_barang.id_barang=barang_dagang.id_barang JOIN anggota ON pembelian_barang.id_anggota=anggota.id_anggota ORDER BY pembelian.tanggal_pembelian") or die(mysqli_error($koneksi));
       ...
       <tr>
        ...
        <td>Rp.<?php echo number_format($row['total_pembelian']); ?>.00</td>
      </tr>
    <?php endwhile; ?>
    <?php
     $sql = $koneksi->query("SELECT SUM(total_harga) FROM pembelian_barang;") or die(mysqli_error($koneksi));
