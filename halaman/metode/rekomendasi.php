<section id="main-content">
      ...
      <?php
        ...
        echo "MAPE = $mape1%";
         ...
         <table class="table table-bordered table-striped table-condensed">
                ...
                <thead align="center">
                    ...
                    <th width="27">No</th>
                    <th width="150">Tanggal</th>
                    <th width="50">Total Pembelian</th>
                    <th width="50">Xi</th>
                    <th width="50">XX</th>
                    <th width="50">XY</th>
                  </tr>
                ...
                $total_xx = 0;
                $total_xy = 0;
                $sql1 = mysqli_query($koneksi,"SELECT *FROM pembelian_barang JOIN pembelian 
                ON pembelian_barang.id_pembelian=pembelian.id_pembelian WHERE pembelian_barang.id_barang='5' 
                AND pembelian_barang.id_anggota='5' ORDER BY pembelian.tanggal_pembelian") or die(mysqli_error());
                while($data1 = mysqli_fetch_array($sql1)){
                  $n = count($data1);
                  $mid = ( ($n - 1) / 2) +1; 
                   $jumlah=$data1['jumlah_barang'];
                ...
                <tr class="gradeX" align="center">
                    <td><?php echo $no; ?></td>
                    <td><?php echo $data1['tanggal_pembelian']; ?></td>
            ...
            <?php 
        function hasila1($total_y,$count){
          $yi = $total_y;
          $ni = $count;
          $a1 = $yi/$ni;
          return $a1;
        }
        function hasilb1($total_xy,$total_xx){
          $xyi = $total_xy;
          $xxi = $total_xx;
          $b1 = $xyi/$xxi;
          return $b1;
        }
        $a1=hasila1($total_y,$count);
        $b1=hasilb1($total_xy,$total_xx);
        echo "Rumus Least Square Regression Line<br>";
        echo "Y = $a + $b * x"
         ?>
         <form class="form-horizontal style-form" method="post" enctype="multipart/form-data">
            ...
            <tr align="center">
             ...
             <?php
             $ni2 = $no-1; 
        function mape1($total_mape,$ni2){
          $MAPE = $total_mape;
          
          $mape11 = $MAPE/$ni2;
          return $mape11;
        }
        function mse1($err2_total,$ni2){
          $er22 = $err2_total;
          $mse1 = $er22/$ni2;
          return $mse1;
        }
        $mape11=mape1($total_mape,$ni2);
        $mse1=mse1($err2_total,$ni2);
        echo "Keterangan Perhitungan Hasil Error <br>";
        echo "- < 10% = Sangat Baik <br>";
        echo "- 10-20% = Baik <br>";
        echo "- 20-50% = Wajar <br>";
        echo "- >50% = Tidak Akurat <br>";
        echo "Hasil Akurasi Pada Least Square Regression Line <br>";
        echo "MSE = $err2_total / $ni2 = $mse1<br>";
        echo "MAPE = $mape11%";
         ?>
