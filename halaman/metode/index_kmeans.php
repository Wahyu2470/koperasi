...
$query = $koneksi->query("SELECT barang_dagang.id_barang, barang_dagang.nama_barang, barang_dagang.jumlah_minimal AS minimal, barang_dagang.jumlah_maksimal AS maksimal, SUM(barang_detail.jumlah_detail) AS barang_masuk, barang_keluar FROM barang_dagang LEFT JOIN barang_detail ON barang_dagang.id_barang=barang_detail.id_barang LEFT JOIN (SELECT barang_dagang.id_barang, SUM(pembelian_barang.jumlah_barang) AS barang_keluar FROM barang_dagang, pembelian_barang WHERE barang_dagang.id_barang=pembelian_barang.id_barang AND pembelian_barang.tanggal_pembelian BETWEEN '2021-03-25' AND '2021-04-25' GROUP BY pembelian_barang.id_barang ASC) AS barang ON barang_dagang.id_barang=barang.id_barang WHERE barang.id_barang IS NOT Null AND barang_detail.tanggal_masuk BETWEEN '2021-03-25' AND '2021-04-25' GROUP BY barang_dagang.id_barang ASC");
	...
	while($row=$query->fetch_assoc()){
		$data[]=[$row['barang_masuk'],$row['barang_keluar'],$row['minimal'],$row['maksimal']];
	}
	...
	$variable_z = 'Jumlah Stok Barang Minimal';
  	$variable_a = 'Jumlah Stok Barang Maksimal';
		...
		<section class="wrapper">
          ...
          <div class="col-lg-12">
            ...
            <div class="float-right">
              ...
              <div align="center">
              <section id="unseen">
              <h4 class="mb"> Periode 25 Maret 2021 s/d 25 April 2021</h4>
              </div>
              <table class="table table-bordered table-striped table-condensed">
                ...
                <thead align="center">
                    ...
                    <th rowspan="1"><?php echo $variable_a; ?></th>
                  </tr>
                </thead>
                <tbody>
                <?php 
                ...
                <tr class="gradeX" align="center">
                    ...
                    <td>C<?php echo ($key_c+1); ?></td>
										<td><?php echo $value_c[0]; ?>.Kg</td>
										<td><?php echo $value_c[1]; ?>.Kg</td>
										<td><?php echo $value_c[2]; ?>.Kg</td>
										<td><?php echo $value_c[3]; ?>.Kg</td>
                </tr>
                <?php 
              $no++;
              } ?>
            ...
            <table class="table table-bordered table-striped table-condensed">
                <br> 
                <h5 class="mb"> Cluster ke <?php echo ($key+1) ?></h5>
                <thead align="center">
                    <tr align="center">
                    <th rowspan="1">No</th>
                    <th rowspan="1">Centroid</th>
            ...
            <table class="table table-bordered table-striped table-condensed">
                ...
                <thead align="center">
                    ...
                    <th rowspan="2"><?php echo $variable_z; ?></th>
                    <th rowspan="2"><?php echo $variable_a; ?></th>
                ...
                <tr class="gradeX" align="center">
                    ...
                    <td><?php echo $barang[$key_data]; ?></td>
										<td><?php echo $value_data['data'][0]; ?>.Kg</td>
										<td><?php echo $value_data['data'][1]; ?>.Kg</td>
										<td><?php echo $value_data['data'][2]; ?>.Kg</td>
										<td><?php echo $value_data['data'][3]; ?>.Kg</td>
                    <?php
            ...
            <div class="float-right">
              <section id="unseen">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Keterangan Cluster</h4>
              <h5 class="mb"><i class="fa fa-angle-right"></i>C1 = Barang Naik</h5>
              <h5 class="mb"><i class="fa fa-angle-right"></i>C2 = Barang Sedang(Rata-Rata)</h5>
              <h5 class="mb"><i class="fa fa-angle-right"></i>C3 = Barang Turun</h5>
              </div>
           	<table class="table table-bordered table-striped table-condensed">
                <br> 
    ...
    plotOptions: {
        scatter: {
            ...
            tooltip: {
                ...
                pointFormat: '{point.x} barang_masuk, {point.y} barang_keluar,{point.z} minimal, {point.a} maksimal'
            }
        }
    },
    series: data
