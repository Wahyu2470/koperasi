        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <?php 
              $id = @$_GET['id'];
              $sql = mysqli_query($koneksi,"SELECT *FROM user where id_user = '$_GET[id]'") or die(mysqli_error());
              ...
              <form class="form-horizontal style-form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Anda" required value="<?php echo $data['nama_user']; ?>">
                  </div>
                </div>
                <div class="form-group">
              ...
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("UPDATE user set nama_user='$_POST[nama]',username='$_POST[username]',password='$_POST[password]' where id_user='$_GET[id]'") or die (mysqli_error($koneksi));
              ?>
