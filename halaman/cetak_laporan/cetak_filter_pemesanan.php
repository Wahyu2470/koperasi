...
<div class="table-responsive" style="padding: 10px;">
  <h3 class="text-center">Laporan Pembelian Anggota</h3>
  <table id="dariom" class="table table-bordered table-striped ">
    ...
    <tbody>
      ...
      $sql = $koneksi->query("SELECT *FROM pembelian_barang JOIN pembelian 
             ...
             ON pembelian_barang.id_barang=barang_dagang.id_barang JOIN anggota ON pembelian_barang.id_anggota=anggota.id_anggota WHERE pembelian_barang.tanggal_pembelian BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."'") or die(mysqli_error($koneksi));
    ...
    <?php
    if (isset($_GET['date1'])&& isset($_GET['date2'])) {
     $sql = $koneksi->query("SELECT SUM(total_harga) FROM pembelian_barang WHEREtanggal_pembelian BETWEEN '".$_GET['date1']."' AND '".$_GET['date2']."';") or die(mysqli_error($koneksi));
