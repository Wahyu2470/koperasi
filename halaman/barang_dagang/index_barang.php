          ...
          <div class="col-lg-12">
            <div class="content-panel">
              <div class="float-right">
                <a href="index.php?halaman=barang&aksi=tambah" class="btn btn-theme">
				...
				<tr class="gradeX" align="center">
                    ...
                    <td>
                    	<a href="index.php?halaman=barang&aksi=edit&id=<?php echo $data['id_barang']; ?>" class="btn btn-theme"><i class="fa fa-cog"></i></a>
                    	<a href="index.php?halaman=barang&aksi=delete&id=<?php echo $data['id_barang']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                <?php 
                $nomor++;
