...
for ($i=2; $i<=$jumlah_baris; $i++){
  ...
  $total_pembelian = $data->val($i, 7);
    ...
    if($id_anggota != "" && $nama != "" && $tanggal_pembelian != "" && $id_pembelian != "" && $jumlah_barang != "" && $total_pembelian != ""){
        ...
        $koneksi->query("INSERT INTO pembelian_barang (id_pembelian,id_anggota,id_barang,total_harga,jumlah_barang,tanggal_pembelian) 
        Values('$keranjang', '$id_anggota', '$id_barang','$total_pembelian', '$jumlah_barang','$tanggal_pembelian')");
