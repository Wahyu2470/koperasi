          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("INSERT INTO anggota(nama_anggota,jenis_kelamin,username,password,alamat,no_tlp,no_ktp,foto_anggota) values('$nama','$jenis_kelamin','$username','$password','$alamat','$notlp','$nik','$fotoidentitas')") or die (mysqli_error());
