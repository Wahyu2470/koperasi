        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <?php 
              $id = @$_GET['id'];
              $sql = mysqli_query($koneksi,"SELECT *FROM manager where id_manager = '$_GET[id]'") or die(mysqli_error());
              ...
              <form class="form-horizontal style-form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama" class="form-control" placeholder="Masukan Nama Anda" required value="<?php echo $data['nama_manager']; ?>">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="file"required name="identitas" class="default" accept="image" value="<?php echo $data['foto_manager']; ?>" />
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-10">
