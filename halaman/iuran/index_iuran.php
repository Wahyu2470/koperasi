        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              <div>
                <a href="index.php?halaman=iuran&aksi=tambah" class="btn btn-theme" style="float: left;">
                  <i class="fa fa-edit"> Tambah Data </i></a>
              </div>
              <div class="nav right">
                <a href="halaman/iuran/cetak_iuran.php" class="btn btn-danger" style="float: right;">
                ...
                <tr class="gradeX" align="center">
                    ...
                    <td>
                        <a href="index.php?halaman=iuran&aksi=edit&id=<?php echo $data['id_iuran']; ?>" class="btn btn-theme"><i class="fa fa-cog"></i></a>
                        <a href="index.php?halaman=iuran&aksi=delete&id=<?php echo $data['id_iuran']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                    </td>
                </tr>
                <?php 
                $nomor++;
