...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Iuran  <?php echo $_SESSION["nama"]?></h3></div>
        <div class="panel-body">
        <a href="tambah_iuran.php" class="btn btn-primary">
                ...
                <tbody>
                    <?php $nomor=1; ?>
                    	<?php 
                            ...
                            $sql = $koneksi->query("SELECT * FROM iuran_detail 
                            JOIN anggota ON iuran_detail.id_anggota = anggota.id_anggota
                            WHERE iuran_detail.id_anggota=$id") or die(mysqli_error($koneksi)); 
