...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Form Iuran</h3></div>
    ...
    <tr>
      ...
      <tr>
        <td><label>Jumlah Iuran</label></td>
        <td><input type="number" name="dana" class="form-control input-lg" placeholder="Masukan Jumlah Iuran Rp."> </td>
      </tr>
      <tr>
    ...
    <?php
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("INSERT INTO iuran_detail(id_anggota,tanggal_iuran,jumlah_iuran) 
                values('$idanggota','$tanggal','$dana')") or die (mysqli_error($koneksi));
              ?>
              <script type="text/javascript">
