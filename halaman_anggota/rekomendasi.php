					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<li><a> <?php $akun = $_SESSION['username'];?> <?php echo "<b style='color:black;'>". $_SESSION['nama']."</b>";?></a></li>
...
<!-- banner -->
		...
		<div class="w3l_banner_nav_right">
			<section class="slider">
				<div class="flexslider">
				 ...
				 <!-- Kami adalah toko oleh-oleh khas bogor yang bernama Koperasi Pasar Kranji Baru<br>
				<b>Selamat Datang</b> -->
	...
	<div class="top-brands">
		<div class="container">
			<h3> Rekomendasi Barang Dagang</h3>
			<div class="agile_top_brands_grids">

              <!-- makanan -->
               <?php
               $id_anggota = $_SESSION['anggota']['id_anggota'];
               $query = mysqli_query($koneksi, "SELECT * FROM barang_dagang JOIN pembelian_barang ON barang_dagang.id_barang=pembelian_barang.id_barang WHERE pembelian_barang.id_anggota=$id_anggota AND pembelian_barang.id_barang AND pembelian_barang.jumlah_barang >= 50 GROUP BY barang_dagang.id_barang DESC");
								...
								<figure>
									<div class="snipcart-item block" >
										...
										<div class="snipcart-details top_brand_home_details">
												...
												<a href="beli.php?id=<?php echo $data['id_barang'];?>" name="simpan" value="Simpan" class="btn btn-primary">Beli &raquo;</a>
												</fieldset>
										</div>
									</div>
								</figure>
			...
			<div class="agile_footer_grids">
				<div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
					<div class="w3_footer_grid_bottom">
						<h4><p>© 2021 KOPERASI PASAR KRANJI BARU | DESIGN BY ALPHATESTER </p></h4>
