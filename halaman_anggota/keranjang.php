...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="hero-unit">Barang Belanjaan Anda</div>
     <div class="panel-body">
                ...
                <tbody>
                    ...
                    <tr>
                    	...
                    	<td>
                    		<a href="tambah_keranjang.php?act=plus&amp;id=<?php echo $data['id_barang'];?>" class="btn btn-primary btn-xs">+</a> 
							<?php echo $jumlah;?> 
							<a href="tambah_keranjang.php?act=min&amp;id=<?php echo $data['id_barang']; ?>" class="btn btn-primary btn-xs">-</a>
                    				
                    	</td>
                    	<td>Rp. <?php echo number_format($subtotal);?></td>
                    	<td><a href="hapuskeranjang.php?id=<?php echo $id_barang?>" class="btn btn-danger btn-xs">hapus</td>
                    </tr>
                <?php $nomor++ ?>
                <?php endforeach ?>
                </tbody>
            </table>
            <a href="index_anggota.php" class="btn btn-default">Lanjutkan Belanja</a>
            <a href="checkout.php" class="btn btn-primary">Checkout &raquo;</a>
