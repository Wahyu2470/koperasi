...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Riwayat Pemesanan  <?php echo $_SESSION["nama"]?></h3></div>
     <div class="panel-body">
        <div class="table-responsive">
                ...
                <tbody>
                    <?php $nomor=1; ?>
                    	<?php 
							...
							ON pembelian_barang.id_barang=barang_dagang.id_barang WHERE pembelian_barang.id_anggota=$id ORDER BY pembelian.tanggal_pembelian") or die(mysqli_error()); 
            ...
            <!-- <tr align="center">
    		<?php
     			$sql = $koneksi->query("SELECT SUM(pembelian_barang.jumlah_barang) AS jumlah_detail, SUM(pembelian_barang.total_harga) AS jumlah_seluruh FROM pembelian_barang JOIN pembelian 
							ON pembelian_barang.id_pembelian=pembelian.id_pembelian JOIN barang_dagang 
							ON pembelian_barang.id_barang=barang_dagang.id_barang WHERE pembelian_barang.id_anggota=$id ORDER BY pembelian.tanggal_pembelian") or die(mysqli_error());
            	$data = $sql->fetch_array();
            	$jumlah_detail = $data['jumlah_detail'];
            	$jumlah_seluruh = $data['jumlah_seluruh'];
    		?>
        		<td colspan="3" align="center">Total Semua</td>
        		<td><?php echo $jumlah_detail ;?>.Kg</td>
        		<td>Rp. <?php echo number_format($jumlah_seluruh) ;?>.00</td>
      		</tr> -->
                </tbody>
            </table>
