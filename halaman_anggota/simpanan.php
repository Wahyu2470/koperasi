...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Simpanan  <?php echo $_SESSION["nama"]?></h3></div>
        <div class="panel-body">
        <a href="tambah_simpanan.php" class="btn btn-primary">
                ...
                <tbody>
                    <?php $nomor=1; ?>
                    	<?php 
                            ...
                            $sql = $koneksi->query("SELECT *FROM simpanan_detail 
                            JOIN anggota ON simpanan_detail.id_anggota = anggota.id_anggota 
                            JOIN jenis_simpanan ON simpanan_detail.id_jenis_simpanan=jenis_simpanan.id_jenis_simpanan
                            JOIN simpanan ON simpanan_detail.id_simpanan=simpanan.id_simpanan 
                            WHERE simpanan_detail.id_anggota=$id AND jenis_simpanan.id_jenis_simpanan") or die(mysqli_error($koneksi)); 
                            while ($data = $sql->fetch_assoc()){
                    	?>
                    <tr>
                    	<td><?php echo $nomor;?></td>
                    	<td><?php echo $data["tanggal_simpan"];?></td>
			...
			<a href="index_anggota.php" class="btn btn-default">Kembali</a>
           </div>
		</div>
		</div>
         </div>
