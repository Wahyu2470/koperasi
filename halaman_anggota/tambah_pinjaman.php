...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Form Pinjaman</h3></div>
    ...
    <tr>
      ...
      <tr>
        ...
        <td><input type="number" name="bulan" id="bulan" class="form-control input-lg" placeholder="" require readonly> </td>
      </tr>
      <tr>
        <td><label>Bunga %</label></td>
        <td><input type="number" name="bunga" id="bunga" class="form-control input-lg" placeholder="" require readonly> </td>
      </tr>
      <tr>
    ...
    <?php
              if (isset($_POST["simpan"])) {
                ...
                $koneksi->query("INSERT INTO pinjaman_anggota(tgl, id_anggota,jumlah,id_cicilan,lama,bunga) 
                values('$tanggal','$idanggota','$dana','$cicilan','$bulan_cicilan','$bunga')") or die (mysqli_error());
                
                $id_pinjam = $koneksi->insert_id;

                $koneksi->query("INSERT INTO pinjaman_detail(id_pinjam,id_cicilan,angsuran,bunga,tgl_bayar,jumlah_bayar) 
                values('$id_pinjam','$cicilan','$angsuran','$bunga','$tanggal','$jumlah_pinjam')") or die (mysqli_error());
              ?>
              <script type="text/javascript">
