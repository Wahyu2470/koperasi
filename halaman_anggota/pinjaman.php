...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Pinjaman  <?php echo $_SESSION["nama"]?></h3></div>
        <div class="panel-body">
        <a href="tambah_pinjaman.php" class="btn btn-primary">
                ...
                <tbody>
                    <?php $nomor=1; ?>
                    	<?php 
                            ...
                            WHERE pinjaman_anggota.id_anggota=$id AND cicilan.id_cicilan") or die(mysqli_error($koneksi)); 
                    ...
                    <tr align="center">
						...
						<td>Rp.<?php echo number_format($data["jumlah_bayar"]);?>.00</td>
