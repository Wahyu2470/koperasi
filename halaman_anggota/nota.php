...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Nota Pemesanan</h3></div>
                         <?php
                                ...
                                <table class="table table-bordered" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
                                         $sql = mysqli_query($koneksi,"SELECT *FROM pembelian_barang JOIN barang_dagang ON 
										 pembelian_barang.id_barang=barang_dagang.id_barang WHERE id_pembelian=$_GET[id]"); ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>Rp.<?php echo number_format($data['harga_kilo']*$data['jumlah_barang']); ?></td>
                                        </tr>   
                                     <?php 
                                    };
                                         ?> 
