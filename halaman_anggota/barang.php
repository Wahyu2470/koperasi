	...
	<div class="top-brands">
		<div class="container">
			...
			<div class="agile_top_brands_grids">
				 <?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM barang_dagang ORDER BY id_barang DESC limit 12");
								...
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<img src="../admin/assets/images/makanan/<?php echo $data ['gambar_barang']; ?>" />	
										...
										<div class="snipcart-details top_brand_home_details">
												<fieldset>
												<a href="detailmakanan.php?id=<?php echo $data['br_id'];?>" class="btn btn-danger">Detail</a> 
												<a href="detailmakanan.php?id=<?php echo $data['br_id'];?>" class="btn btn-success">Beli &raquo;</a>
												</fieldset>
										</div>
									</div>
								</figure>
